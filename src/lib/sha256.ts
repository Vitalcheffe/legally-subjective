/**
 * Pure-JS SHA-256 (synchronous) — Legally Subjective.
 * Needed because the Glyph tilt (Standard LS-1.0, §5) is defined as
 * (int(sha256(docket_id), 16) mod 60) − 30, and must be identical on
 * server and client (no hydration drift, no randomness, ever).
 */
const K = [
