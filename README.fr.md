...
> **Read this in English: [`README.md`](README.md)** — the English README is
> the primary entry point (exhibits, A-to-Z report). Cette version française
> reste la référence historique du dépôt.
